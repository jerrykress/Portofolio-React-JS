const TaskRemindButton = (props) => {
    return (
        <button className={`inline-flex items-center justify-center w-10 h-10 mr-0 mt-3 transition-colors duration-300 bg-white rounded-full focus:outline-none ${props.item.reminder ? "text-green-500" : "text-gray-400"} hover:bg-gray-200 hover:text-green-500`}
