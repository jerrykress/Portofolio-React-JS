...
const ProjectItem = (props) => {
    ...
    return (
        <div className={`flex flex-wrap relative content-between h-auto m-4 mb-6 bg-white border-2 border-gray-300 hover:border-gray-500 transition-colors duration-1000 p-6 rounded-md tracking-wide shadow-lg`} onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)}>
